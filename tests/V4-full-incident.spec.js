...
test('process multiple OnBehalf users', async ({ browser }) => {
  ...
  for (const user of users) {
    ...
    await page.locator('#incidentDate').fill('2025-12-10T13:30');
    ...
    await page.getByRole('button', { name: 'Involved Student(s) P-Number' }).click();
    ...
    // Optionally fill the file name field
